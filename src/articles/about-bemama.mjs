// "About BeMama" category articles , introducing the app to website readers.
// English source content; other languages fall back to English until translated.
// All content is original. General education and support only , not medical advice.

export const appArticles = [
  {
    slug: 'about-bemama/why-bemama',
    category: 'app',
    hero: 'content/app-why-bemama.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
  ...
  {
    slug: 'about-bemama/daily-journey',
    category: 'app',
    hero: 'content/app-daily-journey.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
  ...
  {
    slug: 'about-bemama/qa-and-community',
    category: 'app',
    hero: 'content/app-qa-community.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
        title: 'Q&A and Community: Ask, Learn, and Connect',
        description:
          'How BeMama’s Q&A and community spaces work , ask questions, browse related discussions, and find supportive, moderated connection with others on the same journey.',
        intro:
          'Some questions need an article. Others need a person who has been there. BeMama’s Q&A and community spaces exist for the second kind , a place to ask, browse what others have asked, and feel a little less alone at three in the morning.',
        sections: [
          {
            heading: 'Ask your question, find related answers',
            paragraphs: [
              'In BeMama you can post a question and browse discussions related to it. Often someone has wondered the same thing , whether that is a strange pregnancy symptom, a sleep-routine struggle, or how to feel about a slow month of trying to conceive.',
              'Browsing related threads before or after asking often surfaces perspectives you had not considered, and it means your question joins a living library that helps the next person too.'
            ]
          },
          {
          ...
          {
            heading: 'Why peer support matters in motherhood',
            paragraphs: [
              'Research and lived experience agree: feeling connected to people who understand your situation reduces stress and isolation, especially during pregnancy and the early months with a baby. A clinician can explain what is typical; a peer can tell you what it actually felt like.',
              'Peer support does not replace professional care , it complements it. Hearing "that happened to me too, and here is what helped" is a different kind of medicine, and sometimes exactly the kind you need.'
            ]
          },
          {
            heading: 'Community guidelines keep it kind',
            paragraphs: [
              'BeMama’s guidelines ask members to be respectful, avoid sharing other people’s private information, and keep medical claims humble , sharing experience rather than issuing instructions.',
              'Urgent symptoms and emergencies do not belong in community threads. For anything urgent, BeMama consistently points members to qualified local care or emergency services, because a forum is never the right first responder.'
            ]
          },
          {
            heading: 'A quieter kind of internet',
            paragraphs: [
              'Unlike open social media, BeMama’s spaces are built for one purpose: supporting people through planning, pregnancy, and parenting. No viral outrage, no algorithmic doom , just people at similar stages helping each other through.',
              'You choose how much to share. Reading quietly is participation too, and many members start that way before posting their first question.'
            ]
          }
        ],
        takeaways: [
          'Post questions and browse related discussions from people at your stage.',
          'Spaces are moderated, with reporting and review to keep them safe.',
          'Peer support reduces isolation and complements , never replaces , professional care.',
          'Community guidelines keep conversations kind, respectful, and privacy-aware.',
          'Urgent concerns always belong with local care or emergency services, not a forum.'
        ],
        faq: [
          {
            q: 'Do I have to post to benefit from the community?',
            a: 'Not at all. Many members browse existing questions and discussions quietly. Reading others’ experiences is often valuable on its own, and you can post whenever you feel ready.'
          },
          {
            q: 'What happens if someone is unkind or shares bad information?',
            a: 'You can report the content or account. Moderators may review it and respond , from hiding content to limiting or closing accounts , to keep the space safe and supportive.'
          },
          {
            q: 'Can I ask medical questions in the community?',
            a: 'You can ask about experiences and general topics, but community answers are peer perspectives, not medical advice. For diagnosis, treatment, or anything urgent, contact a qualified healthcare provider.'
          }
        ]
      }
    }
  ...
  {
    slug: 'about-bemama/premium',
    category: 'app',
    hero: 'content/app-premium.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
  ...
  {
    slug: 'about-bemama/ai-support',
    category: 'app',
    hero: 'content/app-ai-support.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
        title: 'How AI-Assisted Support Works in BeMama',
        description:
          'How BeMama’s clearly labeled AI-assisted support works, its firm limits , no diagnosis, prescriptions, or emergency use , and how to use it well alongside your care team.',
        intro:
          'BeMama includes AI-assisted support for general education , and it is always clearly labeled, so you know exactly when you are reading an AI-generated answer. This page explains what that support does, what it deliberately does not do, and how to get the most from it.',
        sections: [
          {
            heading: 'Clearly labeled, always',
            paragraphs: [
              'When AI-assisted features generate a response in BeMama, that response is labeled as AI-assisted. You will never have to guess whether an answer came from an AI system.',
              'This matters because AI answers deserve a particular kind of reading: helpful for background and orientation, but never treated as a clinical verdict. The label is your reminder.'
            ]
          },
          {
            heading: 'What AI-assisted support is for',
            paragraphs: [
              'The AI-assisted features exist for general education: explaining a term your provider used, giving an overview of a topic, helping you understand what is commonly considered typical at your stage, or helping you organize your thoughts.',
              'Used this way, it is like a patient, always-available explainer , good for building background understanding before and after the conversations that really matter.'
            ]
          },
          {
            heading: 'The limits are firm',
            paragraphs: [
              'BeMama’s AI-assisted support does not diagnose conditions, does not prescribe or dose medications, and must not be used in emergencies. These are hard boundaries, not fine print.',
              'AI-generated content can also simply be wrong , incomplete, outdated, biased, or a poor fit for your specific situation. That is inherent to the technology, which is exactly why its role in BeMama is limited to general education.',
              'If you have urgent symptoms or a safety concern, skip the app entirely and contact qualified local care or emergency services.'
            ]
          },
          {
            heading: 'Humans stay in charge of medical decisions',
            paragraphs: [
              'Every medical decision in your journey belongs with you and qualified clinicians , people who can examine you, know your history, and take responsibility for your care. AI-assisted support in BeMama is built to sit firmly below that level.',
              'Think of the hierarchy simply: AI for background education, BeMama’s human community for shared experience, and your clinicians for actual medical judgment.'
            ]
          },
          {
            heading: 'How to use it well',
            paragraphs: [
              'The best use of AI-assisted support is preparation. Ask it to explain a concept before an appointment, use it to understand the vocabulary around a topic, and let it help you draft a list of questions for your provider.',
              'Then bring those questions to a real appointment. Members who use AI-assisted support this way tend to have more focused, confident conversations with their care team , which is the outcome we actually want.'
            ]
          }
        ],
        takeaways: [
          'AI-generated answers in BeMama are always clearly labeled.',
          'AI-assisted support is for general education only.',
          'It does not diagnose, prescribe, dose medication, or handle emergencies.',
          'Medical decisions stay with you and qualified clinicians.',
          'Use it to build background understanding and prepare questions for your provider.'
        ],
        faq: [
          {
            q: 'How do I know when an answer is AI-generated?',
            a: 'AI-assisted responses are clearly labeled in the app. You never have to guess whether you are reading AI-generated content or something else.'
          },
          {
            q: 'Can the AI tell me what is wrong with me or my baby?',
            a: 'No. AI-assisted support does not diagnose. It can offer general educational context, but figuring out what is happening in your specific case is work for a qualified healthcare provider.'
          },
          {
            q: 'What should I do in an emergency?',
            a: 'Do not use the app. Contact local emergency services or qualified urgent care immediately. BeMama’s AI-assisted support is not built for emergencies and must never be used as one.'
          }
        ]
      }
    }
  ...
  {
    slug: 'about-bemama/privacy-and-safety',
    category: 'app',
    hero: 'content/app-privacy.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
        title: 'Your Privacy and Data Safety on BeMama',
        description:
          'A plain-language overview of how BeMama treats sensitive motherhood data , what it is used for, the deletion and export request paths, and where to read the full policy.',
        intro:
          'The information you share on a motherhood journey , cycles, pregnancies, symptoms, your child’s details , is among the most personal data there is. This page explains, in plain language, how BeMama approaches that responsibility. The full privacy policy on the website is always the complete and authoritative version.',
        sections: [
          {
            heading: 'Sensitive data, treated with care',
            paragraphs: [
              'BeMama is designed around the understanding that planning, pregnancy, fertility, baby, child, and wellbeing information is sensitive. That understanding shapes how the app is built and how your information is handled.',
              'The guiding principle is simple: your information exists to serve you inside the app, not to be scattered around. We aim to describe our practices honestly and in plain language rather than burying them in legal fog.'
            ]
          },
          {
            heading: 'What your data is actually used for',
            paragraphs: [
              'Your information is used to provide the features you ask for: personalizing your Daily Journey to your stage, remembering what you track, running your account, and making Q&A and community spaces work.',
              'It is also used for safety and moderation , for example, reviewing reported content to keep community spaces safe , and for practical operations like troubleshooting problems and responding to your support or privacy requests.'
            ]
          },
          {
            heading: 'You can request deletion or export',
            paragraphs: [
              'BeMama provides paths to request deletion of your data and to request an export of it. If you decide to leave, or simply want a copy of your information, those routes exist and are described in the privacy policy.',
              'Requests can be sent through the support channels listed on the website, and the privacy policy explains what to expect from the process.'
            ]
          },
          {
            heading: 'Your choices in everyday use',
            paragraphs: [
              'You control a lot day to day: what you choose to enter, what you post publicly versus keep to yourself, and which device permissions , like notifications, camera, or microphone , you allow. Permissions are requested only for features that need them.',
              'A good habit anywhere on the internet applies here too: keep urgent medical details and other people’s private information out of public community posts.'
            ]
          },
          {
            heading: 'Read the full policy , really',
            paragraphs: [
              'This page is a friendly summary, not the fine print. The full privacy policy on the BeMama website describes what is collected, how it is used and shared, retention basics, and your request paths in detail , and it controls if anything here differs.',
              'We wrote it to be readable. If something in it is unclear, you can ask through the support channels on the site, and we would genuinely rather answer the question than leave you unsure.'
            ]
          }
        ],
        takeaways: [
          'Motherhood data is sensitive, and BeMama is designed around that responsibility.',
          'Your data is used to personalize your journey, run features, and support safety and moderation.',
          'Deletion and export request paths exist and are described in the privacy policy.',
          'You control what you share, what you post publicly, and which device permissions you grant.',
          'The full privacy policy on the website is the complete, authoritative version.'
        ],
        faq: [
          {
            q: 'What is my data used for?',
            a: 'Mainly to provide what you ask for , personalizing your Daily Journey, powering tools and community features, and running your account , plus safety, moderation, and troubleshooting. The privacy policy has the full detail.'
          },
          {
            q: 'Can I delete my data or get a copy of it?',
            a: 'Yes. BeMama provides paths to request deletion and export of your data. The privacy policy and the support channels on the website explain how to make these requests.'
          },
          {
            q: 'Where do I find the complete privacy details?',
            a: 'On the privacy policy page of the BeMama website. It is written in plain language and is the authoritative description of BeMama’s data practices.'
          }
        ]
      }
    }
  ...
  {
    slug: 'about-bemama/getting-started',
    category: 'app',
    hero: 'content/app-getting-started.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {

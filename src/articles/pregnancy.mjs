// "Pregnancy" category articles.
// English source content; other languages fall back to English until translated.
// More articles in this category are added in later authoring batches.
...
export const pregnancyArticles = [
  {
    ...
    i18n: {
      en: {
        ...
        sections: [
          {
            heading: 'What is happening to your baby',
            paragraphs: [
              'Pregnancy is dated from the first day of your last menstrual period, so the first couple of weeks technically happen before conception. After fertilization, the embryo implants in the uterus and begins to grow quickly.',
              'By around week 6 a heartbeat can often be detected, and by the end of week 12 the major organs, limbs, fingers, and toes have formed. Your baby is roughly the size of a lime and is now called a fetus.'
            ]
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              'Avoid alcohol, smoking, and recreational drugs entirely. Limit caffeine (many guidelines suggest keeping it modest), and skip high-risk foods such as raw or undercooked meat and eggs, unpasteurized dairy, high-mercury fish, and deli meats unless heated.',
              'Check any medications and supplements with your healthcare provider before continuing them, since some are not recommended in pregnancy.'
            ]
          },
          {
            heading: 'Your first prenatal appointment',
            paragraphs: [
              'Your first prenatal visit is usually one of the most detailed. Expect a review of your health history, an estimated due date, blood and urine tests, and a chance to ask questions. Some clinics offer an early ultrasound to confirm dating.',
              'This is a good time to discuss any existing conditions, medications, family history, and what care schedule to expect through your pregnancy.'
            ]
          },
          {
          ...
          {
            heading: 'Caring for your mind, too',
            paragraphs: [
              'The first trimester can be an emotional mix of excitement, anxiety, and exhaustion, sometimes before you have even told anyone. That is completely normal.',
              'Rest when you can, lean on your partner or a trusted friend, and reach out to your provider if low mood or anxiety feels persistent. Support early makes a real difference.'
            ]
          }
        ],
        takeaways: [
          ...
          'Know the warning signs (heavy bleeding, severe pain, high fever) and call your provider when unsure.'
        ],
        faq: [
          {
            q: 'When does morning sickness usually start and stop?',
            a: 'Nausea often begins around weeks 6–8 and eases for many people by weeks 12–14, as the first trimester ends. Some experience it longer, and a minority barely at all.'
          },
          {
            q: 'How much folic acid do I need?',
            a: 'Most guidelines recommend a daily prenatal vitamin containing folic acid before conception and through early pregnancy. Confirm the right amount for you with your healthcare provider, as some people need more.'
          },
          {
            q: 'Is light spotting normal in early pregnancy?',
            a: 'Light spotting can be common and often harmless, but heavy bleeding or bleeding with pain should be checked promptly. When in doubt, contact your provider.'
          }
        ]
      }
    }
    ...
    i18n: {
      en: {
        ...
        sections: [
          ...
          {
            heading: 'How your baby is growing',
            paragraphs: [
              'These weeks are a period of rapid, visible growth. Your baby develops hair, eyebrows, and fingerprints; begins to hear sounds from outside the womb; and practices swallowing and even sucking a thumb. By week 27 many babies weigh close to a kilogram (around two pounds).',
              'The lungs, brain, and senses mature steadily throughout, and by late in this trimester your baby may respond to your voice or to music with a wriggle or a kick.'
            ]
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              'The second trimester’s energy makes it the ideal window for practical planning: research childbirth classes, look into your maternity leave options, start thinking about baby gear, and begin conversations about your birth preferences.',
              'It is also a sensible time to book any remaining appointments, plan travel before the third trimester makes it harder, and start a simple list of questions for your care team. Future you will be grateful.'
            ]
          }
        ],
        takeaways: [
          'The second trimester (weeks 13–27) often brings back energy and appetite as nausea fades.',
        ...
        faq: [
          ...
          {
            q: 'What does the anatomy scan check?',
            a: 'It is a detailed ultrasound, usually between weeks 18 and 22, examining your baby’s organs, spine, limbs, and heart, plus the placenta’s position and your baby’s growth. You can often learn the sex at this scan if you wish.'
          },
          {
            q: 'Is it normal to still feel tired in the second trimester?',
            a: 'Yes. Many people get an energy boost, but not everyone does, and pregnancy is hard work throughout. Mention severe or worsening fatigue to your provider, as it can occasionally signal something like low iron.'
          }
        ]
      }
    }
    ...
    i18n: {
      en: {
        ...
        sections: [
          ...
          {
            heading: 'Common third-trimester discomforts',
            paragraphs: [
              'As the bump reaches full size, many people experience backache, pelvic pressure, heartburn, swollen ankles, leg cramps, shortness of breath, and broken sleep. Frequent bathroom trips return with a vengeance as the baby presses on your bladder.',
              'Relief is often about small habits: sleeping on your side with a pillow between your knees, elevating your feet, eating smaller meals, gentle walks, and warm (not hot) baths. Maternity support belts help some people with pelvic and back pressure.',
              'None of this is glamorous, but almost all of it is normal. Raise anything that feels severe, sudden, or one-sided with your care team rather than assuming you must simply endure it.'
            ]
          },
          {
          ...
          {
            heading: 'Braxton Hicks or real labor?',
            paragraphs: [
        ...
        faq: [
          ...
          },
          {
            ...
            a: 'Many babies turn on their own before birth. If yours has not by around weeks 36–37, your provider will discuss options, which may include a procedure to encourage turning or planning the safest delivery approach for your situation.'
          }
        ]
      }
    }
  ...
  {
    slug: 'pregnancy/pregnancy-nutrition',
    category: 'pregnancy',
        ...
        sections: [
          {
            ...
            paragraphs: [
              'A simple template covers most needs: fill about half your plate with vegetables and fruit, a quarter with whole grains, and a quarter with protein such as lean meat, fish, eggs, beans, or tofu, plus dairy or fortified alternatives and healthy fats like olive oil, nuts, and avocado.',
              'Variety matters more than perfection. Different colored vegetables and rotating protein sources naturally broaden the range of vitamins and minerals you take in, without needing to track anything.'
            ]
          },
          {
        ...
        faq: [
          {
            ...
            a: 'Not in the way the phrase suggests. You need no extra calories in the first trimester and only the equivalent of a substantial snack later on. Nutrient quality matters far more than quantity.'
          },
          {
            q: 'Can I get everything I need from diet alone?',
            a: 'A good diet does most of the work, but folic acid in particular is hard to get reliably from food, which is why a prenatal vitamin is recommended. Ask your provider what suits your situation.'
          },
          {
            q: 'What if I am vegetarian or vegan?',
            a: 'Plant-based pregnancies can be perfectly healthy with attention to iron, vitamin B12, calcium, omega-3s, and protein. Tell your provider or a dietitian so they can help you cover any gaps.'
          }
        ]
      }
    }
  },
  {
    ...
    category: 'pregnancy',
    hero: 'content/preg-foods-avoid.jpg',
    updated: 'July 1, 2026',
    i18n: {
      en: {
        ...
        sections: [
          ...
          {
            heading: 'Simple swaps that keep meals enjoyable',
            paragraphs: [
              'Nearly every restricted food has a satisfying stand-in: cooked sushi rolls instead of raw fish, hot paninis instead of cold deli sandwiches, hard or pasteurized cheeses instead of soft mould-ripened ones, and decaf coffee or fruity sparkling water once you hit your caffeine limit.',
              'A little kitchen hygiene rounds out the picture: wash fruit and vegetables, keep raw meat separate from ready-to-eat food, and reheat leftovers until piping hot. With these habits in place, pregnancy eating is far more about what you can enjoy than what you cannot.'
            ]
          }
        ],
        takeaways: [
          'Cook meat, fish, and eggs thoroughly; pause raw preparations like sushi with raw fish.',
          'Skip unpasteurized dairy and soft mould-ripened cheeses; hard and pasteurized cheeses are fine.',
          'Choose low-mercury fish (salmon, sardines, trout) and avoid shark, swordfish, and marlin.',
          'Heat deli meats until steaming; avoid all pâtés.',
          'Keep caffeine modest (~200 mg/day) and avoid alcohol entirely.'
        ],
        faq: [
          {
          ...
          },
          {
            ...
            a: 'Most guidelines suggest keeping caffeine to around 200 mg per day, which is roughly one mug of brewed coffee. Tea, cola, energy drinks, and chocolate count toward that total, so tally the whole day.'
          },
          {
            q: 'What if I ate something on the avoid list before I knew I was pregnant?',
            a: 'The risk from a single exposure is generally low, so try not to worry. Stop now, mention it to your healthcare provider, and contact them promptly if you develop symptoms such as fever or an upset stomach.'
          }
        ]
      }
    }
  ...
  {
    slug: 'pregnancy/common-symptoms',
    category: 'pregnancy',
    ...
    i18n: {
      en: {
        ...
        sections: [
          ...
          {
            heading: 'Swelling in feet and ankles',
            paragraphs: [
          ...
          {
            heading: 'When a symptom needs a call',
            paragraphs: [
              'Most symptoms are uncomfortable but harmless. A few deserve prompt attention: heavy bleeding, severe abdominal pain, a severe or persistent headache, vision changes, sudden swelling of face or hands, high fever, painful urination, fluid leaking from the vagina, or a noticeable drop in your baby’s movements.',
              'The guiding rule is simple: if something feels wrong or you are unsure, call. Maternity teams answer these questions all day, every day, and no one will ever think you are overreacting for checking.'
            ]
          }
        ],
        takeaways: [
        ...
        faq: [
          {
            ...
            a: 'For most people nausea eases between weeks 12 and 16 as the second trimester begins. A smaller group experiences it longer, and severe persistent vomiting should always be discussed with your provider.'
          },
          {
          ...
          },
          {
            ...
            a: 'Some remedies are considered suitable in pregnancy and others are not, so check with your provider or pharmacist before taking anything, including products you used freely before pregnancy.'
          }
        ]
      }
    }
      ...
      en: {
        ...
        sections: [
          ...
          },
          {
            heading: 'What to avoid',
            paragraphs: [
              'Skip activities with a real risk of falls or abdominal impact: contact sports, skiing, horseback riding, outdoor cycling on uneven terrain later in pregnancy, and anything requiring sharp changes of direction. Scuba diving is off the table entirely, and exercising at high altitude without acclimatization is not advised.',
              'Also avoid lying flat on your back for extended exercise after the first trimester (it can compress a major blood vessel), hot yoga and saunas, and breath-holding during effort. When in doubt about a specific activity, ask your provider.'
            ]
          },
          {
        ...
        takeaways: [
          ...
          'Stop and call your provider for bleeding, contractions, chest pain, dizziness, or reduced baby movements.'
        ],
        faq: [
          {
          ...
          {
            q: 'Can I keep running while pregnant?',
            a: 'Many established runners continue well into pregnancy with their provider’s OK, adjusting pace and distance as comfort dictates. Listen to your body, stay cool and hydrated, and switch to lower-impact options if joints or pelvic floor complain.'
          },
          {
            q: 'Is lifting weights safe during pregnancy?',
            a: 'Generally yes with modifications: moderate loads, good form, no breath-holding, and avoiding flat-on-back positions after the first trimester. A trainer familiar with prenatal exercise can help adapt your program.'
          }
        ]
      }
    }
  ...
  {
    slug: 'pregnancy/prenatal-care-schedule',
    category: 'pregnancy',
    ...
    i18n: {
      en: {
        ...
        sections: [
          ...
          {
            heading: 'Second-trimester milestones',
            paragraphs: [
              'The headline appointment of mid-pregnancy is the anatomy scan around weeks 18 to 22, a detailed ultrasound that checks your baby’s organs, growth, and the placenta’s position.',
              'Between weeks 24 and 28, most people are offered a glucose screening test for gestational diabetes, which involves drinking a sweet drink and having blood taken afterward. Routine visits through this trimester also track blood pressure, urine, your baby’s heartbeat, and the growth of your bump.'
            ]
          },
          {
        ...
        faq: [
          {
            q: 'How many prenatal appointments will I have?',
            a: 'Usually around 10 to 15 for an uncomplicated pregnancy, becoming more frequent as you approach your due date. Twins, health conditions, or complications typically mean additional monitoring.'
          },
          {
            q: 'Are the screening tests mandatory?',
            a: 'No. Screening for chromosomal conditions and other optional tests are always your choice. Your provider can explain the benefits, limits, and follow-up options so you can decide what is right for you.'
          },
          {
            q: 'What happens at the glucose test?',
            a: 'You drink a standardized sweet drink and have blood drawn afterward to see how your body handles sugar, screening for gestational diabetes. If the initial screen is elevated, a longer confirmatory test is usually offered.'
          }
        ]
      }
    }
      ...
      en: {
        ...
        faq: [
          ...
          },
          {
            ...
            a: 'Yes. Talking therapies are effective and widely used in pregnancy, and medication options can be discussed with a professional who can weigh benefits and considerations for your situation. Untreated depression carries its own risks, so it is always worth the conversation.'
          }
        ]
      }
    }
  },
  {
    ...
    i18n: {
      en: {
        ...
        faq: [
          {
            q: 'Will I annoy my care team by calling too often?',
    ...
    i18n: {
      en: {
        ...
        takeaways: [
          ...
          'Review it with your provider around weeks 32–36 and pack printed copies in your bag.'
        ],
        faq: [
          {
            q: 'Do I really need a birth plan?',
            a: 'It is optional, but the process is valuable even if the paper never leaves your bag: writing one teaches you your options before labor, when you can think clearly, and helps your team care for you as an individual.'
          },
          {
          ...
          },
          {
            ...
            a: 'Drafting around weeks 28 to 32 and discussing it with your midwife or doctor by weeks 32 to 36 works well. That leaves time to adjust it based on their input and your birthplace’s options before labor begins.'
          }
        ]
      }
    }
  },
  {
    ...
    i18n: {
      en: {
        ...
        takeaways: [
          'Pack by week 36 and make sure your partner knows exactly where the bag is.',
          'For labor: an old nightdress, warm socks, lip balm, snacks, and your playlist.',
          'For after: maternity pads, comfortable underwear, dark loungewear, and your own toiletries.',
          'For baby: a few sleepsuits, a hat, nappies, and an installed rear-facing car seat for the trip home.',
          'Bring documents in one folder; leave valuables and overpacking ambitions at home.'
        ],
        faq: [
          {
            q: 'When should I have my hospital bag packed?',
            a: 'By around week 36 for most pregnancies, and earlier if you are expecting twins or have been told you may deliver early. Keep it somewhere obvious with a short list of last-minute items to grab on top.'
          },
          {
            q: 'How much should I pack for the baby?',
            a: 'Less than instinct suggests: a few sleepsuits and vests, a hat, one packet of newborn nappies, muslins, and a season-appropriate going-home outfit. Hospitals provide the basics, and a visitor can always bring more.'
          },
          {

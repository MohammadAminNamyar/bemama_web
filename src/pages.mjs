  ...
  en: {
    ...
    pages: {
      ...
      'subscription-terms': policy('Subscription Terms', 'Subscription terms for future paid BeMama plans, app store billing, cancellation, refunds, trials, and price changes.', [
        ['Free and premium access', ['BeMama may offer free features and optional premium features. Feature availability, limits, pricing, trial length, renewal period, billing provider, and promotions may vary by platform, country, account, and time.']],
        ['Billing provider', ['If you subscribe or buy through Google Play, Apple App Store, or another payment provider, that provider processes the payment and manages renewal, cancellation, refund, taxes, and payment-method rules. BeMama may receive transaction identifiers, entitlement status, renewal status, cancellation status, country, currency, and related records, but not full payment card numbers.']],
        ['Auto-renewal and cancellation', ['Subscriptions may renew automatically unless cancelled before the renewal deadline shown by the app store or payment provider. Uninstalling BeMama, deleting your account, or stopping app use may not cancel an active subscription. Manage cancellation through the store account or payment provider used to purchase.']],

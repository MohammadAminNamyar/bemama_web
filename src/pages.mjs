...
export const content = {
  ...
  fa: {
    ...
    home: {
      ...
      downloadIos: 'دانلود از اپ‌استور',
      ...
      appText: 'امروز از نسخه وب BeMama استفاده کنید یا اپ اندروید را از Google Play و اپ iOS را از App Store دریافت کنید.',
      android: 'اندروید',
      ios: 'iOS',
      web: 'نسخه وب',
      openAndroid: 'باز کردن در Google Play',
  ...
  ar: {
    ...
    home: {
      ...
      downloadIos: 'التحميل من App Store',
      ...
      appText: 'استخدمي BeMama على الويب اليوم، أو حمّلي تطبيق Android من Google Play وتطبيق iOS من App Store.',
      android: 'Android',
      ios: 'iOS',
      web: 'تطبيق الويب',
      openAndroid: 'فتح في Google Play',
  ...
  fr: {
    ...
    home: {
      ...
      appText: 'Utilisez BeMama sur le web aujourd’hui, téléchargez l’app Android sur Google Play ou l’app iOS sur l’App Store.',
      android: 'Android',
      ios: 'iOS',
      web: 'Application web',
      openAndroid: 'Ouvrir dans Google Play',
  ...
  tr: {
    ...
    home: {
      ...
      downloadIos: 'App Store’dan indirin',
      ...
      appText: 'BeMama’yı bugün webde kullan, Android uygulamasını Google Play’den veya iOS uygulamasını App Store’dan indir.',
      android: 'Android',
      ios: 'iOS',
      web: 'Web uygulaması',
      openAndroid: 'Google Play’de aç',
  ...
  es: {
    ...
    home: {
      ...
      appText: 'Usa BeMama en la web hoy, descarga la app para Android en Google Play o la app para iOS en el App Store.',
      android: 'Android',
      ios: 'iOS',
      web: 'App web',
      openAndroid: 'Abrir en Google Play',
  ...
  pt: {
    ...
    home: {
      ...
      appTitle: 'Abrir BeMama',
      appText: 'Use o BeMama na web hoje, baixe o app Android no Google Play ou o app iOS na App Store.',
      android: 'Android',
      ios: 'iOS',
      web: 'App web',
      openAndroid: 'Abrir no Google Play',

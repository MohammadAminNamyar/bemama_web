...
export const hubUi = {
  en: {
    ...
    readMore: 'Read guide',
    featuredGuides: 'Essential guides to start with',
    featuredGuidesText: 'Clear, evidence-informed answers about pregnancy timing and ovulation tracking.',
    browseAll: 'Browse all',
    featuredInCategory: 'Featured guides',
    browseByTopic: 'Browse by topic',
    timelinesAndMilestones: 'Timelines and milestones',
    everydayGuidance: 'Everyday guidance',
    healthSafetySupport: 'Health, safety, and support',
    planningAndTools: 'Planning and next steps',
    fertilityPregnancyTools: 'Fertility and pregnancy tools',
    babyChildTools: 'Baby and child tools',
    productGuides: 'BeMama feature guides',
    privacySafety: 'Privacy and safety',
    guidesLabel: 'guides',
    showMoreGuides: 'Show more guides',
    showFewerGuides: 'Show fewer guides',
    viewAllCategory: 'View all {category} guides',
    footerExplore: 'Explore',
    footerCompany: 'BeMama',
  ...
  fa: {
    ...
    featuredGuides: 'راهنماهای ضروری برای شروع',
    featuredGuidesText: 'پاسخ‌های روشن و مبتنی بر شواهد درباره زمان‌بندی بارداری و پیگیری تخمک‌گذاری.',
    browseAll: 'مشاهده همه',
    featuredInCategory: 'راهنماهای منتخب',
    browseByTopic: 'مرور بر اساس موضوع',
    timelinesAndMilestones: 'زمان‌بندی و نقاط عطف',
    everydayGuidance: 'راهنمایی روزمره',
    healthSafetySupport: 'سلامت، ایمنی و حمایت',
    planningAndTools: 'برنامه‌ریزی و گام‌های بعدی',
    fertilityPregnancyTools: 'ابزارهای باروری و بارداری',
    babyChildTools: 'ابزارهای نوزاد و کودک',
    productGuides: 'راهنمای قابلیت‌های BeMama',
    privacySafety: 'حریم خصوصی و ایمنی',
    guidesLabel: 'راهنما',
    showMoreGuides: 'نمایش راهنماهای بیشتر',
    showFewerGuides: 'نمایش راهنماهای کمتر',
    viewAllCategory: 'مشاهده همه راهنماهای {category}',
    footerExplore: 'کاوش',
    footerCompany: 'BeMama',
    footerGetApp: 'دریافت اپ',
    footerLegal: 'حقوقی',
  ...
  ar: {
    ...
    featuredGuides: 'أدلة أساسية للبدء',
    featuredGuidesText: 'إجابات واضحة قائمة على الأدلة حول مراحل الحمل وتتبع الإباضة.',
    browseAll: 'عرض الكل',
    featuredInCategory: 'أدلة مختارة',
    browseByTopic: 'تصفح حسب الموضوع',
    timelinesAndMilestones: 'الجداول الزمنية ومراحل النمو',
    everydayGuidance: 'إرشادات يومية',
    healthSafetySupport: 'الصحة والسلامة والدعم',
    planningAndTools: 'التخطيط والخطوات التالية',
    fertilityPregnancyTools: 'أدوات الخصوبة والحمل',
    babyChildTools: 'أدوات الرضيع والطفل',
    productGuides: 'أدلة ميزات BeMama',
    privacySafety: 'الخصوصية والسلامة',
    guidesLabel: 'دليل',
    showMoreGuides: 'عرض المزيد من الأدلة',
    showFewerGuides: 'عرض أدلة أقل',
    viewAllCategory: 'عرض جميع أدلة {category}',
    footerExplore: 'استكشفي',
    footerCompany: 'BeMama',
    footerGetApp: 'حمّلي التطبيق',
    footerLegal: 'قانوني',
  ...
  fr: {
    ...
    featuredGuides: 'Guides essentiels pour commencer',
    featuredGuidesText: 'Des réponses claires et fondées sur les preuves sur les étapes de la grossesse et le suivi de l’ovulation.',
    browseAll: 'Tout parcourir',
    featuredInCategory: 'Guides à la une',
    browseByTopic: 'Explorer par thème',
    timelinesAndMilestones: 'Calendriers et étapes clés',
    everydayGuidance: 'Conseils du quotidien',
    healthSafetySupport: 'Santé, sécurité et soutien',
    planningAndTools: 'Planification et prochaines étapes',
    fertilityPregnancyTools: 'Outils de fertilité et de grossesse',
    babyChildTools: 'Outils pour bébé et enfant',
    productGuides: 'Guides des fonctionnalités BeMama',
    privacySafety: 'Confidentialité et sécurité',
    guidesLabel: 'guides',
    showMoreGuides: 'Afficher plus de guides',
    showFewerGuides: 'Afficher moins de guides',
    viewAllCategory: 'Voir tous les guides {category}',
    footerExplore: 'Explorer',
    footerCompany: 'BeMama',
    footerGetApp: 'Télécharger l’application',
  ...
  tr: {
    ...
    featuredGuides: 'Başlamak için temel rehberler',
    featuredGuidesText: 'Gebelik dönemleri ve yumurtlama takibi hakkında açık, kanıta dayalı yanıtlar.',
    browseAll: 'Tümünü görüntüle',
    featuredInCategory: 'Öne çıkan rehberler',
    browseByTopic: 'Konuya göre göz at',
    timelinesAndMilestones: 'Zaman çizelgeleri ve gelişim adımları',
    everydayGuidance: 'Günlük rehberlik',
    healthSafetySupport: 'Sağlık, güvenlik ve destek',
    planningAndTools: 'Planlama ve sonraki adımlar',
    fertilityPregnancyTools: 'Doğurganlık ve gebelik araçları',
    babyChildTools: 'Bebek ve çocuk araçları',
    productGuides: 'BeMama özellik rehberleri',
    privacySafety: 'Gizlilik ve güvenlik',
    guidesLabel: 'rehber',
    showMoreGuides: 'Daha fazla rehber göster',
    showFewerGuides: 'Daha az rehber göster',
    viewAllCategory: 'Tüm {category} rehberlerini görüntüle',
    footerExplore: 'Keşfet',
    footerCompany: 'BeMama',
    footerGetApp: 'Uygulamayı edinin',
    footerLegal: 'Yasal',
  ...
  es: {
    ...
    featuredGuides: 'Guías esenciales para empezar',
    featuredGuidesText: 'Respuestas claras y basadas en evidencia sobre las etapas del embarazo y el seguimiento de la ovulación.',
    browseAll: 'Ver todo',
    featuredInCategory: 'Guías destacadas',
    browseByTopic: 'Explorar por tema',
    timelinesAndMilestones: 'Cronología e hitos',
    everydayGuidance: 'Orientación cotidiana',
    healthSafetySupport: 'Salud, seguridad y apoyo',
    planningAndTools: 'Planificación y próximos pasos',
    fertilityPregnancyTools: 'Herramientas de fertilidad y embarazo',
    babyChildTools: 'Herramientas para bebés y niños',
    productGuides: 'Guías de funciones de BeMama',
    privacySafety: 'Privacidad y seguridad',
    guidesLabel: 'guías',
    showMoreGuides: 'Mostrar más guías',
    showFewerGuides: 'Mostrar menos guías',
    viewAllCategory: 'Ver todas las guías de {category}',
    footerExplore: 'Explorar',
    footerCompany: 'BeMama',
    footerGetApp: 'Descarga la app',
    footerLegal: 'Legal',
  ...
  pt: {
    ...
    readMore: 'Ler o guia',
    featuredGuides: 'Guias essenciais para começar',
    featuredGuidesText: 'Respostas claras e baseadas em evidências sobre as fases da gravidez e o acompanhamento da ovulação.',
    browseAll: 'Ver tudo',
    featuredInCategory: 'Guias em destaque',
    browseByTopic: 'Explorar por tema',
    timelinesAndMilestones: 'Cronogramas e marcos',
    everydayGuidance: 'Orientação para o dia a dia',
    healthSafetySupport: 'Saúde, segurança e apoio',
    planningAndTools: 'Planejamento e próximos passos',
    fertilityPregnancyTools: 'Ferramentas de fertilidade e gravidez',
    babyChildTools: 'Ferramentas para bebês e crianças',
    productGuides: 'Guias de recursos da BeMama',
    privacySafety: 'Privacidade e segurança',
    guidesLabel: 'guias',
    showMoreGuides: 'Mostrar mais guias',
    showFewerGuides: 'Mostrar menos guias',
    viewAllCategory: 'Ver todos os guias de {category}',
    footerExplore: 'Explorar',
    footerCompany: 'BeMama',
